    ...
    <form action="" method="post" class="border border-black">
      ...
      <section class="mb-8">
        ...
        <div class="px-5 flex flex-col">
          <input class="border border-black mb-3" type="text" placeholder="Primer Apellido" required>
          ...
          <select name="grado" class="border border-black mb-3">
      ...
      <section class="mb-4">
        ...
        <!-- BORN INFORMATION -->
        <section class="mb-4">
          <h2 class="bg-sky-700 text-center text-white p-4 mb-5">Informacion de Nacimiento</h2>

          <div class="px-5 flex flex-col">
            <input class="mb-3 border border-black" type="text" placeholder="lugar de nacimiento">
            <input class="mb-3 border border-black" type="text" placeholder="municipio de nacimiento">
            <input class="mb-3 border border-black" type="text" placeholder="departamento">
            <input class="mb-3 border border-black" type="text" placeholder="pais">
          </div>
        </section>
        ...
        <section class="mb-4">
          ...
          <div class="px-5 flex flex-col">
            <input class="mb-3 border border-black" type="text" placeholder="dirección de la residencia">
            <input class="mb-3 border border-black" type="text" placeholder="telefono Fijo">
            <input class="mb-3 border border-black" type="text" placeholder="Correo electronico">
            <input class="mb-3 border border-black" type="text" placeholder="numero Celular">
